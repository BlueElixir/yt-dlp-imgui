...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsDarkC(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsLight(ImGuiStyle* dst = NULL);   // best used with borders and a custom, thicker font
    IMGUI_API void          StyleColorsLightC(ImGuiStyle* dst = NULL);   // best used with borders and a custom, thicker font
    ...
    IMGUI_API void          LoadingIndicatorCircle(const char* label, const float indicator_radius, const ImVec4& main_color, const ImVec4& backdrop_color, const int circle_count, const float speed);
    IMGUI_API void          Spinner(const char* label, float radius, int thickness, const ImU32& color);
    ...
    IMGUI_API bool          button(const char* label, const char* id, const ImVec2& size_arg, const char* icon_label, bool ico = false);
